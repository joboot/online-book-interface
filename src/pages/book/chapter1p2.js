...
const Ch1Page2 = () => {
    ...
    return (
        <div>
            ...
            <br/>
            <p>
                No matter what language you are using, your first program should probably be a <b>"Hello World" Program</b>.
            ...
            <br/>
            <img src={require("../../images/helloWorld.png")} width="300px" alt="Hello World Meme"/>
            <br/>
            <br/>
            <Button variant="dark" onClick={() => {navigate('../chapter1p1')}}>
                Previous page: Chapter 1, Section 1: Programming Languages
            </Button>
            <br/>
            <br/>
